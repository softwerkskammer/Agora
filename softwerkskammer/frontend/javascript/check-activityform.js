...
(function () {
  ...
  $(document).ready(function () {
    var validateDateAndTime = function () {
      ...
      return (
        ...
        dateAndTime.end &&
        dateAndTime.start &&
        dateAndTime.end.getTime() - dateAndTime.start.getTime() > 0
      );
    };
  ...
  function initValidator() {
    ...
    [
      ...
      "#activityform [name=assignedGroup]",
      "#activityform [name=location]",
      "#activityform [name=startDate]",
      "#activityform [name=startTime]",
      "#activityform [name=endDate]",
      "#activityform [name=endTime]",
      "#activityform [name=url]",
