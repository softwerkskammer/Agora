  ...
  [
    callback => { // create groups
      const groups = [
        ...
        {id: 'crafterswap', emailPrefix: 'crafterswap', description: 'D-Scription', longName: 'Crafter Swaps', type: 'Regionalgruppe', color: '#0000ff', mapX: '100', mapY: '200', shortName: 'CS'},
