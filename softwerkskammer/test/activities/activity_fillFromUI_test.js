...
describe("Activity (when filled from UI)", () => {
  ...
  describe("creates a resource", () => {
    it("without limit", () => {
      const activity = new Activity().fillFromUI({
        resources: { names: "Veranstaltung", limits: "", previousNames: "" },
      });
    ...
    it("with limit 0", () => {
      const activity = new Activity().fillFromUI({
        resources: { names: "Veranstaltung", limits: "0", previousNames: "" },
      });
    ...
    it("with limit", () => {
      const activity = new Activity().fillFromUI({
        resources: { names: "Veranstaltung", limits: "10", previousNames: "" },
      });
  ...
  describe("adds a limit", () => {
    it("to a resource without limit", () => {
      const activity = new Activity({ resources: { Veranstaltung: { _registeredMembers: [] } } }).fillFromUI({
        resources: { names: "Veranstaltung", limits: "10", previousNames: "Veranstaltung" },
      });
