  ...
  describe('group submission', () => {
    ...
    describe('of a new group', () => {
      ...
      it('saves the whole group info to the database and redirects to the new group\'s page', done => {
        request(createApp({id: 'someMember'}))
          .post('/submit')
          .send('id=newgroup&emailPrefix=SONEW&longName=ANewGroup&color=#AABBCC&description=WeLoveIt&type=Regionalgruppe&organizers=someMember&contactingOrganizersEnabled=on')
          .expect(302)
