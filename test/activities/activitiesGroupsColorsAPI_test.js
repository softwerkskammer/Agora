...
describe('Activity, Groups and Colors API', function () {

  beforeEach(function (done) {
    sinon.stub(activitiesAPI, 'allActivities', function (callback) {callback(null, [dummyActivity]); });
  ...
  it('returns an activity and enhances it with its color and group name', function () {
    activitiesGroupsColorsAPI.getActivitiesForDisplay(activitiesAPI.allActivities, function (err, activities) {
