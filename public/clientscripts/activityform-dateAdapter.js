var dateAdapter = function () {
  ...
  init(toUtc($('#startDate').val(), $('#startTime').val()));
  ...
  var listener = function () {
    ...
    var currentTimes = calculateNewDates({startDate: currentStartDate, startTime: currentStartTime, endDate: currentEndDate, endTime: currentEndTime});
