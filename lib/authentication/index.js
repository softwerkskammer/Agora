...
module.exports = function (app) {
  ...
  function serializeUser(user, done) {
    done(null, user.authenticationId);
  }

  function deserializeUser(authenticationId, done) {
    membersAPI.getMemberForAuthentication(authenticationId, function (err, member) {
      if (err) { return done(err); }
      done(null, {authenticationId: authenticationId, member: member});
    });
  }
