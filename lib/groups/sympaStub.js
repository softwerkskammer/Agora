    ...
    var item =
      [
        {homepage: 'http://swk.monoceres.uberspace.de/fcgi-bin/sympa.fcgi/info/craftsmanswap',
          ...
          listAddress: 'craftsmanswap@softwerkskammer.de'},
        {homepage: 'http://swk.monoceres.uberspace.de/fcgi-bin/sympa.fcgi/info/neueplattform',
          ...
          listAddress: 'neueplattform@softwerkskammer.de'}
      ];
    callback(null, item);
  };
...
// isSubscriber: true/false
  ...
  client.getAllAvailableGroups = getAllAvailableLists;
  client.getUsersOfList = getUsersOfList;
  client.getSubscribedGroupsForUser = getSubscribedListsForUser;
