...
app.get('/checkgroupname', function (req, res) {
  misc.validate(req.query.id, null, groupsAPI.isGroupNameAvailable, res.end);
});

app.get('/checkemailprefix', function (req, res) {
  misc.validate(req.query.emailPrefix, null, groupsAPI.isEmailPrefixAvailable, res.end);
});
