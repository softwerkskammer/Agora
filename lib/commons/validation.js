...
module.exports = {
  ...
  isValidActivity: function (activity) {
    ...
    validator.check(activity.url, "URL darf nur alphanumerische Zeichen enthalten.").isAlphanumeric();
  ...
  isValidAnnouncement: function (announcement) {
    ...
    validator.check(announcement.url, "URL darf nur alphanumerische Zeichen enthalten.").isAlphanumeric(); // TODO: evtl. nicht so streng prüfen
    validator.check(announcement.shortDescription, "Kurzbeschreibung ist ein Pflichtfeld.").notEmpty();
    validator.check(announcement.text, "Text ist ein Pflichtfeld.").notEmpty();
    validator.check(announcement.author, "Autor ist ein Pflichtfeld.").notEmpty();
    validator.check(announcement.thruDate, "thruDate ist ein Pflichtfeld.").notEmpty();
    return validator.getErrors();
  }
};
