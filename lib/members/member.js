...
function Member(object) {
  ...
  if (object && object.nickname) {
    this.id = fieldHelpers.valueOrFallback(object.id, this.id);
    this.nickname = fieldHelpers.valueOrFallback(object.nickname, this.nickname);
    this.firstname = fieldHelpers.valueOrFallback(object.firstname, this.firstname);
    this.lastname = fieldHelpers.valueOrFallback(object.lastname, this.lastname);
    this.email = fieldHelpers.valueOrFallback(object.email, this.email);
    this.setTwitter(fieldHelpers.valueOrFallback(object.twitter, this.twitter));
    this.location = fieldHelpers.valueOrFallback(object.location, this.location);
    this.profession = fieldHelpers.valueOrFallback(object.profession, this.profession);
    this.interests = fieldHelpers.valueOrFallback(object.interests, this.interests);
    this.setSite(fieldHelpers.valueOrFallback(object.site, this.site));
    this.reference = fieldHelpers.valueOrFallback(object.reference, this.reference);
    this.isAdmin = !!fieldHelpers.valueOrFallback(object.isAdmin, this.isAdmin);
    this.created = fieldHelpers.valueOrFallback(object.created, this.created);
    this.authentications = fieldHelpers.valueOrFallback(object.authentications, [this.id]);
  }
}
