...
Member.prototype.avatarUrl = function (size) {
  return 'https://www.gravatar.com/avatar/' + fieldHelpers.md5(this.email()) + '?d=blank&s=' + (size ? size : 32);
};
...
Member.prototype.isInGroup = function (groupId) {
  return this.subscribedGroups && _.some(this.subscribedGroups, function (subscribedGroup) { return subscribedGroup.id === groupId; });
};
