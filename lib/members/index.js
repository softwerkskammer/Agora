...
module.exports = function (app) {
  ...
  app.post('/submit', function (req, res, next) {
    async.parallel([
      function (callback) {
        validation.checkValidity(req.body.previousNickname, req.body.nickname, api.isValidNickname, 'Dieser Nickname ist leider nicht verfügbar.', callback);
      },
      function (callback) {
        validation.checkValidity(req.body.previousEmail, req.body.email, api.isValidEmail, 'Diese Adresse ist schon registriert. Hast Du bereits ein Profil angelegt?', callback);
      },
      function (callback) {
        var memberOfRequest = new Member(req.body);
