...
module.exports = function () {
  return {
    ...
    create: function (app) {
      ...
      var groupsAndMembers = require('../groupsAndMembers/groupsAndMembersAPI');
      ...
      function saveMember(memberOfRequest, previousMemberData, req, res, next) {
        api.saveMember(memberOfRequest, function (err, member) {
          ...
          if (req.user.member) {
            return res.redirect('/members/edit' + memberOfRequest.nickname);
          }
      ...
      function memberSubmitted(req, res, next) {
        validation.isReqBodyValidMember(req, res, function () {
      ...
      app.post('/submit', function (req, res, next) {
        ...
        validation.isReqBodyValidNewMember(req, res, api, function () {
