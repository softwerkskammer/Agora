  ...
  return {
    ...
    create: function (app) {
      ...
      function memberSubmitted(req, res, next) {
        ...
        redirectIfNotAdmin(req, res, nicknameOfEditMember);
      ...
      function redirectIfNotAdmin(req, res, nicknameOfEditMember) {
        if (!userIsRegistered(req) || (!req.user.member.isAdmin && req.user.member.nickname !== nicknameOfEditMember)) {
          res.redirect(urlPrefix + '/members/' + (nicknameOfEditMember ? nicknameOfEditMember : ''));
        }
      }
