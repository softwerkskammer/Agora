...
module.exports = function (app) {
  ...
  app.post('/submit', function (req, res, next) {
    ...
    if (accessForbiddenTo(activityUrl, res)) {
      return res.redirect('/activities/upcoming');
    }

    var args = {nickname: req.body.nickname, activityUrl: activityUrl, resourcename: req.body.resourceName, hoursstring: req.body.registrationValidForHours};
