...
module.exports = function (app) {
  ...
  function messageSubmitted(req, res, next) {
    ...
    if (req.body.toParticipants) {
      ...
      return activitiesCoreAPI.getActivity(activityURL, function (err, activity) {
  ...
  app.get('/invitation/:activityUrl', function (req, res, next) {
    async.parallel({
        activity: function (callback) { activitiesCoreAPI.getActivity(req.params.activityUrl, callback); },
