...
module.exports = function (app) {
  ...
  function messageSubmitted(req, res) {
    ...
    function processResult(err, type) {
      err ?
        statusmessage.errorMessage(req, 'message.title.email_problem', 'message.content.mailsender.error_reason', {type: type, err: err.toString()}) :
        statusmessage.successMessage(req, 'message.title.email_successful', 'message.content.mailsender.success', {type: type});
    ...
    statusmessage.errorMessage(req, 'message.title.email_problem', 'message.content.mailsender.error_no_recipient');
    res.redirect(req.body.successURL);
  }
