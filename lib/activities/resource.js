...
Resource.prototype.addMemberIdToWaitinglist = function (memberId, momentOfRegistration) {
  if (this.membersOnWaitinglist().indexOf(memberId) === -1) {
...
Resource.prototype.membersOnWaitinglist = function () {
  if (!this.hasWaitinglist()) {
    return [];
  }
  return _.pluck(this.state._waitinglist, 'memberId');
};
