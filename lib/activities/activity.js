...
Activity.prototype.allMembersOnWaitinglist = function () {
  return this.resources().allMembersOnWaitinglist();
};
...
Activity.prototype.registrationOpenFor = function (resourceName) {
  return this.resources().named(resourceName).isRegistrationOpen();
};

Activity.prototype.hasWaitinglist = function (resourceName) {
  return this.resources().named(resourceName).hasWaitinglist();
};
