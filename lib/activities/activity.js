...
Activity.prototype.registeredMembers = function (resourceName) {
  return this.resourceNamed(resourceName).registeredMembers();
};

Activity.prototype.addMemberId = function (memberId, resourceName, moment) {
  this.resourceNamed(resourceName).addMemberId(memberId, moment);
};

Activity.prototype.removeMemberId = function (memberId, resourceName) {
  this.resourceNamed(resourceName).removeMemberId(memberId);
};

Activity.prototype.isFull = function (resourceName) {
  return this.resourceNamed(resourceName).isFull();
};

Activity.prototype.numberOfFreeSlots = function (resourceName) {
  return this.resourceNamed(resourceName).numberOfFreeSlots();
};

Activity.prototype.registrationOpenFor = function (resourceName) {
  return this.resourceNamed(resourceName).isRegistrationOpen();
};

Activity.prototype.hasWaitinglist = function (resourceName) {
  return this.resourceNamed(resourceName).hasWaitinglist();
};
