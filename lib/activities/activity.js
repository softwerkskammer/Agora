...
Activity.prototype.updateStartDateWith = function (value) {
  this.state.startUnix = fieldHelpers.parseToUnixUsingDefaultTimezone(value, this.startTime());
};

Activity.prototype.updateEndDateWith = function (value) {
  this.state.endUnix = fieldHelpers.parseToUnixUsingDefaultTimezone(value, this.endTime());
};
