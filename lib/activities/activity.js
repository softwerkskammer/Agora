...
function Activity(object) {
  if (object) {
    ...
    // BBB transitioning from direct property to function
    this._registeredMembers = misc.toArray(object._registeredMembers || object.registeredMembers);
  } else {
