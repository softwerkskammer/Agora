...
Activity.prototype.fillFromDB = function (object) {
  if (object) {
    ...
    if (object.resources) {
      ...
      _.each(Object.keys(object.resources), function (key) {
        res[key] = new Resource(object.resources[key]._registeredMembers);
      });
    }
    else {
      // this is for backwards compatibility
      this.resources = {default: new Resource(misc.toArray(object.registeredMembers))};
    }
  }
  return this;
};
...
Activity.prototype.registeredMembers = function (resource) {
  ...
  return this.resources[actualResource].registeredMembers();
};
