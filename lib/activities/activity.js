...
Activity.prototype.startDate = function () {
  return moment.unix(this.startUnix).utc().format('DD.MM.YYYY');
};

Activity.prototype.startTime = function () {
  return moment.unix(this.startUnix).utc().format('HH:mm');
};

Activity.prototype.endDate = function () {
  return moment.unix(this.endUnix).utc().format('DD.MM.YYYY');
};

Activity.prototype.endTime = function () {
  return moment.unix(this.endUnix).utc().format('HH:mm');
};
