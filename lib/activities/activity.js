...
Activity.prototype.resetForClone = function () {
  ...
  result.resources().named('default')._registeredMembers = [];
  return result;
};
...
Activity.prototype.copyFrom = function (originalActivity) {
  ...
  this.state.resources = {default: new Resource(misc.toArray(
    originalActivity.resources() && originalActivity.resources().named('default') ?
      originalActivity.resources().named('default')._registeredMembers : originalActivity.registeredMembers()))};
  return this;
};
