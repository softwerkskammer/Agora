...
function matchArrayEntries(input) {
  return _.object(misc.toArray(input['names']), misc.toArray(input['limits']));
}
...
Activity.prototype.fillFromUI = function (object) {
  ...
  if (object.resources) {
    var newResources = matchArrayEntries(object.resources);
    _.each(newResources, function (limit, name) {
