...
Activity.prototype.fillAddonConfig = function (object) {
  ...
  function setOrDeleteAddonInformation() {
    if (object.addon_information) {
      self.state._addonConfig['addon_information'] = object.addon_information;
    } else {
      delete self.state._addonConfig.addon_information;
    }
  }
  ...
  setOrDeleteBoolean('home_address');
  setOrDeleteBoolean('billing_address');
  setOrDeleteBoolean('t_shirt_size');
...
// Add-On information as entered by the participants:
