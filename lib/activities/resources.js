...
Resources.prototype.allMembersOnWaitinglist = function () {
  var allMemberIdsOnWaitinglist = [];
  for (var key in this.state) {
    allMemberIdsOnWaitinglist = allMemberIdsOnWaitinglist.concat(this.named(key).membersOnWaitinglist());
  }
  return _.uniq(allMemberIdsOnWaitinglist);
};
