  ...
  function activitiesForDisplay(activitesFetcher, next, res, title) {
    async.parallel(
      { activities: activitesFetcher,
        groups: function (callback) { groups.getAllAvailableGroups(callback); },
        colors: function (callback) { colors.allColors(callback); },
        groupColors: function (callback) { groups.allColors(callback); }
      },
