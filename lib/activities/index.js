...
module.exports = function (app) {
  ...
  app.get('/addons/:activityUrl', function (req, res, next) {
    addonAPI.activityAndAddonLines(req.params.activityUrl, function (err, activity, addonLines) {
      if (err) { return next(err); }
      res.render('addonTable', {activity: activity, addonLines: addonLines});
    });
  });
