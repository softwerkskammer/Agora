...
var reservedURLs = '^edit$|^new$|^checkurl$|^submit$|^administration$|\\+';
...
module.exports = function (app) {
  ...
  app.post('/submit', function (req, res, next) {
    ...
    async.parallel([
      function (callback) {
        ...
        var validityChecker = function (url, callback) { activitiesCoreAPI.isValidUrl(reservedURLs, url, callback); };
  ...
  app.get('/checkurl', function (req, res) {
    ...
    activitiesCoreAPI.isValidUrl(reservedURLs, url, function (err, result) {
