...
module.exports = function (app) {
  ...
  function activitiesForDisplay(activitesFetcher, next, res, title, i18n) {
    async.parallel(
      ...
      function (err, results) {
        ...
        res.render('index', { activities: results.activities, groups: results.groups,
          groupColors: results.groupColors, colors: results.colors, range: title, i18n: i18n});
      });
  }
  ...
  app.get('/', function (req, res, next) {
    ...
    var title = 'Alle';
    activitiesForDisplay(activitesFetcher, next, res, title, req.i18n);
  });
