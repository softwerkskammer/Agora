...
module.exports = function (app) {
  ...
  app.get('/upcoming', function (req, res, next) {
    activitiesForDisplay(activitiesCoreAPI.upcomingActivities, next, res, req.i18n.t("activities.upcoming"));
  });

  app.get('/past', function (req, res, next) {
    activitiesForDisplay(activitiesCoreAPI.pastActivities, next, res, req.i18n.t("activities.past"));
  });
