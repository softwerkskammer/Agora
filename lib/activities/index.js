  ...
  app.get('/:url', function (req, res, next) {
    async.parallel({
      ...
      function (err, results) {
        ...
        var allRegisteredMembers = activity.allRegisteredMembers();
        var visitors = results.members.filter(function (member) {
          return allRegisteredMembers.indexOf(member.id) > -1;
        });
