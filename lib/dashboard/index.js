...
var transformMail = function (language, mail) {
  ...
  if (mail.memberNickname()) {
    result.memberNickname = mail.memberNickname();
  }

  if (mail.displayedSenderName()) {
    result.displayedSenderName = mail.displayedSenderName();
  }
  ...
  result.sortedResponses = transformMail(language, mail.sortedResponses());
  return result;
};

var transformMails = function (mails, language) {
