...
app.get('/json/subscribedGroups/:memberNickname', function (req, res, next) {
  groupsAndMembersService.getUserWithHisGroups(req.params.memberNickname, function (err, member) {
    if (err) { return next(err); }
...
app.get('/json/events/:memberNickname', function (req, res, next) {
