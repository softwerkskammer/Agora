module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // Task configuration.
    jshint: {
      files: ['**/*.js', '**/*.json', '.jshintrc', '!node_modules/**/*.js', '!node_modules/**/*.json', '!public/**/*.js', '!public/**/*.json', '!frontendtests/lib/**/*.js', '!frontendtests/lib/**/*.json', '!frontendtests_vendor/*', '!frontendtests_manual/*'],
      options: {
        jshintrc: '.jshintrc'
      }
    },
