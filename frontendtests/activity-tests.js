...
(function () {
  ...
  describe('Activitiy Form', function () {
    ...
    var checkFieldWithPositiveAjaxResponse = function (field) {
      testglobals.checkFieldWithPositiveAjaxResponse(sandbox, activity_validator, field);
    };

    var checkFieldWithNegativeAjaxResponse = function (field, message) {
      testglobals.checkFieldWithNegativeAjaxResponse(sandbox, activity_validator, field, message);
    };
